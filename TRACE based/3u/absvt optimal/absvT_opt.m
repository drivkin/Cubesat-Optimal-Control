% run F = v*T cost function using dyamics as described in trace paper
...
%---------------------------------------
bounds.lower.states = [-10; -10; -10; -100; -100;-100; -1;-1;-1;-1];
...
absvTprob.cost = 'absvTcost';
absvTprob.dynamics = 'TBDynamics';
absvTprob.events = 'TBEvents';

absvTprob.bounds = bounds;

algorithm.nodes = 64 % represents some measure of desired solution accuracy
...
[cost, primal, dual] = dido(absvTprob, algorithm);
runTime = cputime-tStart
% Ta da!

%save workspace
save(['absvT_' num2str(algorithm.nodes) 'Nsoln']);
